...
const SigninPage = () => {
  ...
  return (
    <div className="w-full min-h-screen flex flex-col justify-center items-center px-6 pt-28 pb-16 bg-[#faf7f2]">
      <div className="w-full max-w-[420px] bg-white/70 backdrop-blur-xl rounded-3xl p-8 sm:p-10 shadow-[0_20px_40px_rgba(0,0,0,0.04)] border border-white">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-extrabold text-[#1a1a1a] mb-2 tracking-tight">Welcome back</h1>
          <p className="text-[15px] text-zinc-500">Sign in to your Launchpad account</p>
        </div>
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-3 bg-white/70 text-zinc-400 font-medium">Or continue with</span>
          </div>
        </div>
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div className="space-y-1.5">
            <div className="flex justify-between items-center pl-1 pr-1">
              <label className="text-[13px] font-semibold text-[#1a1a1a]" htmlFor="password">Password</label>
              <Link to="/forgot-password" className="text-[13px] font-semibold text-[#E67A62] hover:text-[#D66D57] transition-colors">
                Forgot password?
              </Link>
            </div>
            <Input
        ...
        <div className="mt-8 text-center text-[14px] text-zinc-500 font-medium">
          ...
          <Link to="/signup" className="text-[#E67A62] hover:text-[#D66D57] font-semibold transition-colors">
            Sign up
          </Link>
        </div>
      </div>
